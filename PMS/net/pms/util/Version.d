...
public final class Version : Comparable<Version> {
	 ...
	 */
	public bool isLessThanOrEqualTo(Version other) {
		return compareTo(other) <= 0;
	}
	 ...
	 */
	public bool isGreaterThanOrEqualTo(Version other) {
		return compareTo(other) >= 0;
	}
	 ...
	 */
	public static bool isPmsUpdatable(Version vFrom, Version vTo) {
	 ...
	 */
	private final int[] getCanonicalElements() {
