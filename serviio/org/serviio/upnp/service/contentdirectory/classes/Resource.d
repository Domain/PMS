...
public class Resource
{
  ...
  public this(ResourceType resourceType, Long resourceId, MediaFormatProfile version, Integer protocolInfoIndex, QualityType quality, Boolean transcoded)
  {
  ...
  private void validate()
    {
    if ((resourceId is null) || (resourceType is null) || ((resourceType == ResourceType.MEDIA_ITEM) && ((version is null) || (quality is null) || (protocolInfoIndex is null))))
