  ...
  public static void retrieveImageMetadata(ImageMetadata md, String imageLocation, bool local)
    ...
    try
    {
      ...
      if (imageFormat == ImageFormat.IMAGE_FORMAT_JPEG)
        ...
        throw new InvalidMediaFormatException(String.format("File %s has unsupported image format", new Object[] { byteSource.getFilename() }));
      }

      strategy.extractMetadata(md, byteSource);
    } catch (ImageReadException e) {
      log.warn(String.format("Cannot read image file %s", new Object[] { imageLocation }));
