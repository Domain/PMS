...
public class RangeHeaders
{
  ...
  protected static Double convertNPTToSeconds(String npt)
    ...
    if (npt.indexOf(":") > -1)
    {
      ...
      Double seconds = Double.valueOf(Double.valueOf(timeFields[0]).doubleValue() * 3600.0D + Double.valueOf(timeFields[1]).doubleValue() * 60.0D + Double.valueOf(timeFields[2]).doubleValue());
